...
export function NavBar(){
    return <nav className=" md:mb-20 mb-8 flex items-center justify-between py-6">
        <div className="flex flex-shrink-0 items-center">
            <h1 className="w-10 text-5xl text-white font-semibold">VI.</h1>
        </div>
        <div className="m-8 flex items-center justify-center gap-4 text-2xl">
            <a href="https://www.linkedin.com/in/victorien-ilunga-335630314/">
            ...
            <a href="https://github.com/VictorienIlunga">
            ...
            <a href="https://www.instagram.com/victorienilunga/">
